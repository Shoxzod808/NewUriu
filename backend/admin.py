...
class ContactAdmin(admin.ModelAdmin):
    list_display = ('full_name', 'phone', 'directions', 'education_type', 'status', 'called', 'wait', 'ac','created')
    list_editable = ['status', 'called', 'wait', 'ac']
...
class PeopleAdmin(admin.ModelAdmin):
    list_display = ('id', 'photo', 'full_name_uz', 'proffesion_uz', 'phone', 'email')  # Поля, которые будут отображаться в списке
