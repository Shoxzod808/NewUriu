...
class Contact(models.Model):
    ...
    status = models.BooleanField(default=False, verbose_name='Telefon urdim')
    called = models.BooleanField(default=False, verbose_name='Telefonni olmadi')
    wait = models.BooleanField(default=False, verbose_name='Galmidi')
    ac = models.BooleanField(default=False, verbose_name='Galdi')
