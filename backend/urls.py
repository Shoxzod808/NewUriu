...
urlpatterns = [
    ...
    path("<str:language>/markazlar_va_bolimlar/<str:tag>", views.markazlar_va_bolimlar_teg, name="markazlar_va_bolimlar_teg"),
    path("<str:language>/rektorat/", views.rektorat, name="rektorat"),
    path("<str:language>/rekvizitlar/", views.rekvizitlar, name="rekvizitlar"),
    path("<str:language>/ilmiy_faoliyat/", views.ilmiy_faoliyat, name="ilmiy_faoliyat"),
